...
public class MenuItem extends JPanel {
    ...
    public MenuItem(StaffMenu menu, String menus[], int menuIndex, List<MenuEvent> events) {
        this.menu = menu;
        this.menus = menus;
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("raven/menu/staffIcon/" + menuIndex + ".svg");
